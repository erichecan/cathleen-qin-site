...
export default function Contact() {
  ...
  return (
    <section id="contact" className="border-t-2 border-gold bg-sand/60 px-6 py-28 sm:px-10 sm:py-40">
        ...
        <Reveal>
          ...
          <p className="mt-16 border-t border-line pt-8 text-[0.92rem] text-muted sm:mt-20">
            ...
            <a
              ...
              className="text-ink underline decoration-line underline-offset-4 hover:text-gold-strong"
            >
